 ...
 * 반품지 생성
 */
public class CreateReturnShippingCenter {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Invoke API
            ResponseDtoOfSimpleResultDto result = apiInstance.createReturnShippingCenter(VENDOR_ID, createShippingPlaceDetailDto(), VENDOR_ID);

            //print result
            Gson gson = new GsonBuilder().setPrettyPrinting().create();
            System.out.println("result : " + gson.toJson(result));
        } catch (ApiException e) {
            System.err.println("Exception when calling createReturnShippingCenter! " + e.getResponseBody());
        }
    }
    ...
    private static ShippingPlaceDetailDto createShippingPlaceDetailDto() {
        ...
        shippingPlaceDetailDto.setReturnCenterCode("XYZ");
