...
import com.coupang.marketplace.client.model.product.OpenApiPagedResultOfOSellerProductStatusHistory;
 ...
 * 상품 상태변경이력 조회
 */
public class ReadSellerProductHistory {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Invoke API
            OpenApiPagedResultOfOSellerProductStatusHistory result = apiInstance.readSellerProductHistory(VENDOR_ID, sellerProductId);
